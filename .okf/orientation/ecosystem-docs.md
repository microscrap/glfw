...
description: "Published ScrapyardIO ecosystem docs for microscrap/glfw 0.7.x."
resource: "https://scrapyard-io.projectsaturnstudios.com/ecosystem/microscrap/glfw/0.7.x/overview"
...
[https://scrapyard-io.projectsaturnstudios.com/ecosystem/microscrap/glfw/0.7.x/overview](https://scrapyard-io.projectsaturnstudios.com/ecosystem/microscrap/glfw/0.7.x/overview)

`composer.json` `homepage` / `support.docs` point at that overview.[^composer-homepage]
